...
ReaderView.paintTo = function(self, bb, x, y)
    ...
    local header_margin = Size.padding.small -- Use this instead, if book margins is set to false
    ...
    local left_corner_header = string.format("%s %s %s", wifi(), separator.dot, battery)
